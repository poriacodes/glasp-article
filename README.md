...
- [**Getting Started With Glasp**](#getting-started-with-glasp)
    ...
    - [**2. Click on Continue with Google and select your preferred Google account in the popup.**](#2-click-on-continue-with-google-and-selected-your-preferred-google-account-in-the-popup)
    - [**3. Select your favourite topics from the box, then click "Save".**](#3-select-your-favourite-topics-from-the-box-then-click-on-save)
